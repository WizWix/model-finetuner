...
case "$SAVE_STEPS" in
  ''|*[!0-9]*|0) echo "오류: SAVE_STEPS는 1 이상의 정수여야 합니다. 현재값='$SAVE_STEPS'"; exit 1 ;;
esac
case "$EVAL_STEPS" in
  ''|*[!0-9]*) echo "오류: EVAL_STEPS는 0 이상의 정수여야 합니다. 현재값='$EVAL_STEPS'"; exit 1 ;;
esac
case "$LOGGING_STEPS" in
  ''|*[!0-9]*|0) echo "오류: LOGGING_STEPS는 1 이상의 정수여야 합니다. 현재값='$LOGGING_STEPS'"; exit 1 ;;
esac
